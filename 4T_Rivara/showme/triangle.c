...

{
  ...
  if (((leftvertex[0] == endpoint2[0]) && (leftvertex[1] == endpoint2[1])) ||
    ...
    if (crosssubseg.ss == m->dummysub) {
      ...
      segmentintersection(m, b, &crosstri, &i, &i, &i,  &crosstri, &i, &i, &i,  &crosstri, &i, &i, &i,  &crosstri, &i, &i, &i,  &crosstri, &i, &i, &i,  &crosstri, &i, &i, &i,  &crosstri, &i, &i, &i,  &crosstri, &i, &i, &i,  &crosstri, &i, &i, &i,  &